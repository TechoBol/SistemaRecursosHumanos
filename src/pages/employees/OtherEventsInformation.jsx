...
const OtherEventsInformation = () => {
  const [openMonthId, setOpenMonthId] = useState(null);

  const handleRegister = () => {
    console.log("Registrar evento salarial");
  };
  ...
  return (
    <>
      <TabContentCard>
        <TabHeader>
          <div>
            <SectionTitle>Eventos salariales</SectionTitle>

            <TabDescription>
              Bonos y/o descuentos del mes
            </TabDescription>
          </div>
        ...
        <EmptyState>
          <DollarSign size={48} strokeWidth={1.6} />
...
export default OtherEventsInformation;